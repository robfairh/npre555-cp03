...
Section \ref{sec:results-1st} displays the results of a one-energy group exercise presented in \cite{brantley_simplifiedP3_2000}.
...
This section describes the a one-energy group, isotropic-scattering eigenvalue problem introduced by Brantley and Larsen \cite{brantley_simplifiedP3_2000}.
...
The convergence criteria was 10 $\times ^{-8}$ for the neutron flux.
...
Table \ref{tab:keff-1st} compares between the eigenvalue obtained with the SP3 solver and the reference value using the equation
\begin{align}
