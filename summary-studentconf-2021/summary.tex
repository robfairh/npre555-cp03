...
Section \ref{sec:results-1st} discusses the results of a one group exercise presented in \cite{brantley_simplifiedP3_2000}.
Section \ref{sec:results-2nd} describes the results of the C5 MOX Benchmark \cite{cavarec_benchmark_1994}.
