...
\begin{figure}[htbp!] %or H 
    \centering
    \includegraphics[width=0.85\linewidth]{figures/brantley-larsen.png}
    \hfill
...
\begin{figure}[htbp!] %or H 
    \centering
    \includegraphics[width=0.9\linewidth]{figures/bench-config.png}
    \hfill
...
\begin{figure}[htbp!] %or H 
    \centering
    \includegraphics[trim=0 0 0 2.1cm, clip=true, width=0.9\linewidth]{figures/bench-config2.png}
    \hfill
...
\begin{figure}[h] %or H 
    ...
    \includegraphics[trim=0 0 0 2.1cm, clip=true, width=0.9\linewidth]{figures/bench-config3.png}
    \hfill
