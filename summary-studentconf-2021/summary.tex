...
\begin{table}[]
	...
	\midrule
	Normal scheme (eq. \ref{eq:diff-rem})		& 0.96969	& 0.97106	& 145					\\
	Transport correction (eq. \ref{eq:diff-tr})	& 0.93755	& 0.93792	& 43					\\
	\bottomrule
	\end{tabular}
\end{table}
...
To simplify the display of the results, Figure \ref{fig:power-distrib} presents the power distribution in each assembly and the relative difference to the reference.
