...
Figure \ref{fig:power-pbp} shows the relative error of the pin power distribution calculated with Cerberus in the MOX assembly located in the lower right of Figure ??.
