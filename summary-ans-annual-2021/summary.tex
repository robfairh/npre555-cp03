...
\begin{figure}[htbp!] %or H 
    \centering
    \includegraphics[width=0.7\linewidth]{figures/mesh2.png}
    \hfill
...
\begin{figure}[h] %or H 
    \centering
    \includegraphics[width=0.65\linewidth]{figures/geo-xz2.png}
    \hfill
...
\begin{figure}[h] %or H 
    \centering
    \includegraphics[width=0.85\linewidth]{figures/C5G23D-distrib.png}
    \hfill
