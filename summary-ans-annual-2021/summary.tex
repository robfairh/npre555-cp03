...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Cerberus: A MOOSE-based application for solving the $SP_3$ equations}
...
% what I am doing
This work presents the implementation of the Simplified $P_3$ ($SP_3$) equations \cite{gelbard_spherical_1960} in the \gls{MOOSE}-based application Cerberus.
% MOOSE
...
While Cerberus solves the neutronics in a nuclear reactor using the $SP_3$ equations, other applications may solve the thermal-fluids, and given they share the same API; their integration is straightforward.
